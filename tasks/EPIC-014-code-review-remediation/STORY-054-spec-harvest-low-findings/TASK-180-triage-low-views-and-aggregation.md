...
findings: [SH-L347, SH-L348, SH-L349, SH-L350, SH-L351, SH-L352, SH-L353, SH-L354, SH-L355, SH-L356, SH-L357, SH-L358, SH-L359, SH-L360, SH-L361, SH-L362, SH-L363, SH-L364, SH-L365, SH-L366]
pr: null
github-issue: null
jira-key: null
---

# Triage the 20 low spec-harvest findings in `views-and-aggregation`
...
**Findings:** `SH-L347`–`SH-L366` (contiguous), detailed in
[`SPEC-HARVEST-FINDINGS-2026-07-30.md`](../SPEC-HARVEST-FINDINGS-2026-07-30.md) § Low severity →
`### area: views-and-aggregation`, lines 5140–5261.
...
- The other 367 low findings — they belong to the other 21 per-area tasks under [[STORY-054]].
- High-severity findings in this area — [[STORY-051]] owns those.
- Medium-severity findings in this area — [[TASK-151]] owns them. Where a fix closes both, do it once and
