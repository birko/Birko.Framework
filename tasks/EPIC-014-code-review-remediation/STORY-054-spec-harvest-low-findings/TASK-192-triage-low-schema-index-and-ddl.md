...
findings: [SH-L207, SH-L208, SH-L209, SH-L210, SH-L211, SH-L212, SH-L213, SH-L214, SH-L215, SH-L216]
pr: null
github-issue: null
jira-key: null
---

# Triage the 10 low spec-harvest findings in `schema-index-and-ddl`
...
**Findings:** `SH-L207`–`SH-L216` (contiguous), detailed in
[`SPEC-HARVEST-FINDINGS-2026-07-30.md`](../SPEC-HARVEST-FINDINGS-2026-07-30.md) § Low severity →
`### area: schema-index-and-ddl`, lines 4282–4343.
...
- Medium-severity findings in this area — [[TASK-154]] owns them. Where a fix closes both, do it once and
...
_Populated by `/tasks plan TASK-192` — leave empty until then._
