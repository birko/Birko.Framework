...
findings: [SH-L088, SH-L089, SH-L090, SH-L091, SH-L092, SH-L093, SH-L094, SH-L095, SH-L096, SH-L097, SH-L098, SH-L099, SH-L100, SH-L101]
pr: null
github-issue: null
jira-key: null
---

# Triage the 14 low spec-harvest findings in `entity-tagging`
...
that fall in the `entity-tagging` area.

**Findings:** `SH-L088`–`SH-L101` (contiguous), detailed in
[`SPEC-HARVEST-FINDINGS-2026-07-30.md`](../SPEC-HARVEST-FINDINGS-2026-07-30.md) § Low severity →
`### area: entity-tagging`, lines 3556–3641.

**The contract under review** is specced in [`docs/specs/entity-tagging.md`](../../../docs/specs/entity-tagging.md), harvested from
1 source glob — `../Birko.Data.Tagging/**/*.cs`. Every one of
...
`docs/specs/entity-tagging.md` lying until `/specs regen entity-tagging` runs, and **that spec diff is the fix's evidence**.
...
- [ ] Any behavioural fix is followed by `/specs regen entity-tagging`, with the spec diff reviewed as the change's
      evidence
...
- The other 373 low findings — they belong to the other 21 per-area tasks under [[STORY-054]].
- High-severity findings in this area — [[STORY-051]] owns those.
- Medium-severity findings in this area — [[TASK-166]] owns them. Where a fix closes both, do it once and
...
_Populated by `/tasks plan TASK-186` — leave empty until then._
