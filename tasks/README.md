...
- **EPIC-009** [Birko.Communication — Remaining protocols](EPIC-009-communication-protocols/EPIC.md) — planned (0/2)
  ...
  - STORY-020 [OAuth2 server](EPIC-009-communication-protocols/STORY-020-oauth2-server/STORY.md) — planned (0/1)
    - [ ] [TASK-027](EPIC-009-communication-protocols/STORY-020-oauth2-server/TASK-027-birko-security-oauth-server.md) Implement Birko.Security.OAuth.Server (P2, ai)
