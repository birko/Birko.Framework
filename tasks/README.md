...
- [TASK-223](EPIC-014-code-review-remediation/STORY-051-spec-harvest-high-findings/TASK-223-cosmos-connection-mode-cannot-be-selected.md)
  CosmosDB's connection mode cannot be selected (P1, ai) — the emulator is only the symptom; the
  defect is that a consumer behind a proxy or firewall cannot use the Cosmos store at all, since
  Gateway mode is exactly the documented fallback for that. Also unblocks the last never-run suite
...
- **EPIC-014** [Code review — audit remediation](EPIC-014-code-review-remediation/EPIC.md) — in-progress (13/63 tasks done)
  ...
  - STORY-051 [Spec-harvest — high findings](EPIC-014-code-review-remediation/STORY-051-spec-harvest-high-findings/STORY.md) — in-progress (27/29, 1 in review, 1 new)
    ...
    - [ ] [TASK-223](EPIC-014-code-review-remediation/STORY-051-spec-harvest-high-findings/TASK-223-cosmos-connection-mode-cannot-be-selected.md) CosmosDB's connection mode cannot be selected — Gateway is unreachable, so the emulator is too (P1, ai) · FEATURE-014
