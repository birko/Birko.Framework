...
- **EPIC-014** Code review — audit remediation — in-progress (54/113 tasks done)
  ...
  - _tracked directly on the epic_
    ...
    - [ ] [TASK-246](EPIC-014-code-review-remediation/TASK-246-migration-unique-index-is-silently-not-unique.md) A migration's `.Unique()` silently builds a NON-unique index on every SQL provider · FEATURE-014
