...
Todo by priority: **P0 0 · P1 28 · P2 92 · P3 10**
...
- **EPIC-014** Code review — audit remediation — in-progress (75/148 tasks done)
  ...
  - _tracked directly on the epic_
    ...
    - [x] [TASK-254](EPIC-014-code-review-remediation/TASK-254-a-failed-hypertable-conversion-bricks-the-store.md) A hypertable conversion that cannot succeed now bricks the store instead of degrading · FEATURE-014
    - [ ] [TASK-283](EPIC-014-code-review-remediation/TASK-283-a-throwing-index-failure-subscriber-bricks-the-store.md) A throwing `OnIndexCreationFailed` subscriber defeats TASK-204’s degrade and bricks the entity · FEATURE-014
    ...
    - [x] [TASK-281](EPIC-014-code-review-remediation/TASK-281-continuous-aggregate-may-never-have-worked-through-the-runner.md) A continuous aggregate cannot be created or refreshed inside a transaction — so it may never have worked through the runner at all · FEATURE-014
    - [ ] [TASK-282](EPIC-014-code-review-remediation/TASK-282-route-the-timescaledb-emitters-through-the-connector.md) The TimescaleDB migration emitters bypass the connector — an option TASK-259 reopened and nobody owns · FEATURE-014
    ...
    - [x] [TASK-260](EPIC-014-code-review-remediation/TASK-260-continuous-aggregate-takes-raw-sql-fragments.md) `CreateContinuousAggregate` takes two raw SQL fragments that cannot be contained · FEATURE-014
    - [ ] [TASK-284](EPIC-014-code-review-remediation/TASK-284-an-empty-start-offset-silently-widens-a-refresh-policy.md) An empty `startOffset` silently widens a refresh policy to all of history — and the escape hatch that relies on it is untested · FEATURE-014
