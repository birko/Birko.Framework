...
_Generated 2026-07-17. Run `/tasks triage` to refresh. **Do not hand-edit** — changes will be overwritten._
...
- [TASK-042](EPIC-016-birko-backports-from-reps/STORY-039-cross-provider-sql-di/TASK-042-store-factory-di-mssql-mysql-postgres.md) Cross-provider SQL store-factory + DI (P2, ai) — offline tests green; live CRUD round-trip blocked on STORY-042 harness
...
- **EPIC-014** [Code review — audit remediation](EPIC-014-code-review-remediation/EPIC.md) — in-progress (864 findings; tasks extracted on demand from CODE-REVIEW-AUDIT-2026-06-17.md)
  ...
  - STORY-026 [Medium findings (275)](EPIC-014-code-review-remediation/STORY-026-medium-findings/STORY.md) — in-progress (267/275; the last 8 are Docker-gated → STORY-042)
  - STORY-027 [Low findings (418)](EPIC-014-code-review-remediation/STORY-027-low-findings/STORY.md) — done (CR-L001 … CR-L418, 418/418)
  - STORY-042 [Integration-test tier (8, theme)](EPIC-014-code-review-remediation/STORY-042-integration-test-tier/STORY.md) — planned (Docker-gated findings from STORY-026: M089/108/109/138/159/160/164/165; M166 closed offline via TASK-058)
  - STORY-043 [Workflow serializer seam (theme)](EPIC-014-code-review-remediation/STORY-043-workflow-serializer-seam/STORY.md) — done (ISerializer across all 7 workflow backends + camelCase unify + null-Guid guard)
- **EPIC-016** [Birko framework backports from Reps (+ cross-provider & Xaml follow-ups)](EPIC-016-birko-backports-from-reps/EPIC.md) — in-progress (migrated from Consumers/WorkoutTracker EPIC-002; 4/5 stories done)
  ...
  - STORY-039 [Cross-provider SQL store-factory + DI backport](EPIC-016-birko-backports-from-reps/STORY-039-cross-provider-sql-di/STORY.md) — in-progress (0/1; 1 in review)
    - [ ] [TASK-042](EPIC-016-birko-backports-from-reps/STORY-039-cross-provider-sql-di/TASK-042-store-factory-di-mssql-mysql-postgres.md) Backport store-factory + DI extension to MSSql / MySQL / PostgreSQL (P2, ai) 🔍 review — live CRUD blocked on STORY-042 harness
...
<details>
<summary>Completed (2 epics)</summary>
...
- **EPIC-015** [Birko.Xaml — Avalonia-first XAML UI framework](EPIC-015-birko-xaml-ui-framework/EPIC.md) — done (8 stories + follow-up controls: Slider, field-type parity, date/time pickers, multi-select/tags/file)
  ...
  - [x] [TASK-057](EPIC-015-birko-xaml-ui-framework/TASK-057-xaml-form-multiselect-tags-file.md) Form field types: MultiSelect / Tags / File (P2, ai) — **done** (File OS-dialog pick = manual)
