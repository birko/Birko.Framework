...
- **EPIC-014** Code review — audit remediation — in-progress (66/140 tasks done)
  ...
  - _tracked directly on the epic_
    ...
    - [ ] [TASK-277](EPIC-014-code-review-remediation/TASK-277-sqlite-swallows-a-write-to-a-missing-table.md) On SQLite a write to a missing table reports SUCCESS — `OnException` swallows it · FEATURE-014
