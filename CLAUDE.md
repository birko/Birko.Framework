...
### Birko.Security.AspNetCore — server-side role resolution + claim-delimiter fix (2026-06-25)
...
### Birko.Web.Testing — shared E2E / browser-automation package (2026-06-24)
...
### Birko.Web.Components — b-accordion + shared `coerceCssLength` (2026-06-19)
...
### Birko.Data.Stores — `ReadFirst` / `ReadFirstAsync` on bulk stores (2026-06-15)
...
### Birko.Web.Components — accessibility (ARIA / screen-reader) pass (2026-06-15)
...
### Birko.Web — `finstat` theme + 5 new themeable tokens (2026-06-10)
...
### Birko.Web — modular, per-project opt-in themes (2026-06-10)
...
### Birko.Security.OAuth.Server — OAuth2 authorization server (2026-05-29)
