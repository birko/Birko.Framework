...
# Birko.MessageQueue — Provider expansion — Decisions
...
|----|----------|-------|-----------|------|----|---------|
| D1 | RabbitMQ (AMQP) ([[STORY-010]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-014]] |
| D2 | Kafka ([[STORY-011]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-015]] |
| D3 | Cloud queue providers (Azure Service Bus + AWS SQS) ([[STORY-012]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-016]], [[TASK-017]] |
| D4 | MassTransit adapter ([[STORY-013]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-018]] |
...
- 2026-08-01 — **Ledger opened by backfill**, not by a `/feature new` interview. This feature was created to
  close the [[roadmap]] DV5 gap: `EPIC-006` had been tracked in `tasks/` since 2026-05-28 while this repo's
