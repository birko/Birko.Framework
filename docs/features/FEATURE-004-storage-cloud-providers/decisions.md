...
# Birko.Storage — Cloud providers — Decisions
...
|----|----------|-------|-----------|------|----|---------|
| D1 | AWS S3 storage ([[STORY-004]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-006]] |
| D2 | Google Cloud Storage ([[STORY-005]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-007]] |
| D3 | MinIO (S3-compatible) ([[STORY-006]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-008]] |
...
- 2026-08-01 — **Ledger opened by backfill**, not by a `/feature new` interview. This feature was created to
  close the [[roadmap]] DV5 gap: `EPIC-004` had been tracked in `tasks/` since 2026-05-28 while this repo's
