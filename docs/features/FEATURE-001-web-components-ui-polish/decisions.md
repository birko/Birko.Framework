...
| D4 | Form-associated custom elements (ElementInternals) ([[STORY-023]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `in-progress`. | 2026-06-15 | ai | [[TASK-035]] |
