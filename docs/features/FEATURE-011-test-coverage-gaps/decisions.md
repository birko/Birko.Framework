...
# Birko.Framework — Test coverage gaps — Decisions
...
|----|----------|-------|-----------|------|----|---------|
| D1 | Redis-dependent tests ([[STORY-021]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-029]], [[TASK-030]] |
| D2 | Phase 4 lower-priority tests ([[STORY-022]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-031]], [[TASK-032]], [[TASK-033]] |
| D3 | Review filter-parser behaviour on live document databases ([[STORY-047]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-07-18 | ai | [[TASK-060]] |
| D4 | Work tracked directly on the epic, outside any story | approved | Backfilled: these tasks exist and are tracked, so the scope decision was taken. | 2026-05-28 | ai | [[TASK-052]] |
...
- 2026-08-01 — **Ledger opened by backfill**, not by a `/feature new` interview. This feature was created to
  close the [[roadmap]] DV5 gap: `EPIC-011` had been tracked in `tasks/` since 2026-05-28 while this repo's
