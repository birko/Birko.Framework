...
# Birko.Health — Queue + cloud health checks — Decisions
...
|----|----------|-------|-----------|------|----|---------|
| D1 | Message queue health checks ([[STORY-017]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-022]], [[TASK-023]] |
| D2 | Cloud queue health checks ([[STORY-018]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-024]], [[TASK-025]] |
...
- 2026-08-01 — **Ledger opened by backfill**, not by a `/feature new` interview. This feature was created to
  close the [[roadmap]] DV5 gap: `EPIC-008` had been tracked in `tasks/` since 2026-05-28 while this repo's
