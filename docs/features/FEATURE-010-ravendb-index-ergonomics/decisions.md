...
# Birko.Data.RavenDB — Index ergonomics — Decisions
...
|----|----------|-------|-----------|------|----|---------|
| D1 | Work tracked directly on the epic, outside any story | approved | Backfilled: these tasks exist and are tracked, so the scope decision was taken. | 2026-05-28 | ai | [[TASK-028]] |
...
- 2026-08-01 — **Ledger opened by backfill**, not by a `/feature new` interview. This feature was created to
  close the [[roadmap]] DV5 gap: `EPIC-010` had been tracked in `tasks/` since 2026-05-28 while this repo's
