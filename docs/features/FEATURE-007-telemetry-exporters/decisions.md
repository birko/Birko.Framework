...
# Birko.Telemetry — Additional exporters — Decisions
...
|----|----------|-------|-----------|------|----|---------|
| D1 | Prometheus exporter ([[STORY-014]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-019]] |
| D2 | Seq log exporter ([[STORY-015]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-020]] |
| D3 | Grafana LGTM stack exporter ([[STORY-016]]) | approved | Backfilled: decomposed into tracked work, so the scope decision was taken. Story is `planned`. | 2026-05-28 | ai | [[TASK-021]] |
...
- 2026-08-01 — **Ledger opened by backfill**, not by a `/feature new` interview. This feature was created to
  close the [[roadmap]] DV5 gap: `EPIC-007` had been tracked in `tasks/` since 2026-05-28 while this repo's
